# AI Task Capture System — Project Overview
...
* локальна перевірка не залежала від платного сервісу;
...
| docs       | Технічна документація та інструкції запуску |
...
## 17. Відповідність технічним критеріям MVP
...
| Критерій            | Як закрито                                                                       |
| ------------------- | -------------------------------------------------------------------------------- |
| Чіткий опис проєкту | Є в README і `docs/PROJECT_OVERVIEW.md`                                         |
...
* Docker-запуск;
* тести;
* технічну документацію для перевірки та запуску.
